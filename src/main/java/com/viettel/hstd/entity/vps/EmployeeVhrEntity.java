...
@Entity
@Slf4j
public class EmployeeVhrEntity {
    @Id
...
//    private LocalDate lastDate;
    ...
    public void setDateOfBirth(LocalDate dateOfBirth) {
        if (dateOfBirth != null) {
            this.dateOfBirth = dateOfBirth.atStartOfDay(ZoneId.systemDefault()).toEpochSecond() + "000";
        } else {
            this.dateOfBirth = LocalDate.of(1998, 05, 28).toEpochDay() + "";
        }
    ...
    public LocalDate getJoinCompanyDate() {
        LocalDateTime ldt = TimeUtil.convertStringEpochMilliSecondToLocalDateTime(joinCompanyDate);
        return ldt == null ? null : ldt.toLocalDate();
    }

    public void setJoinCompanyDate(LocalDate joinCompanyDate) {
        if (joinCompanyDate != null) {
            this.joinCompanyDate = joinCompanyDate.atStartOfDay(ZoneId.systemDefault()).toEpochSecond() + "000";
        } else {
            this.joinCompanyDate = null;
        }
    }

    public LocalDate getPersonalIdIssuedDate() {
        if (dateOfBirth == null) return null;
        LocalDateTime ldt = TimeUtil.convertStringEpochMilliSecondToLocalDateTime(dateOfBirth);
        return ldt == null ? null : ldt.toLocalDate();
    }

    public void setPersonalIdIssuedDate(LocalDate personalIdIssuedDate) {
        if (joinCompanyDate != null) {
            this.personalIdIssuedDate = personalIdIssuedDate.toEpochDay() + "";
        } else {
            this.personalIdIssuedDate = null;
        }
    }
}
