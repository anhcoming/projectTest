...
public class ResignTypeSerializer extends JsonSerializer<ResignType> {
    @Override
    public void serialize(ResignType value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
