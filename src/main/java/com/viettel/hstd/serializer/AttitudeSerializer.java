...
public class AttitudeSerializer extends JsonSerializer<Attitude> {
    @Override
    public void serialize(Attitude value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
