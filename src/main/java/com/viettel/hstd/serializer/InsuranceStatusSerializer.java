...
public class InsuranceStatusSerializer extends JsonSerializer<InsuranceStatus> {
    @Override
    public void serialize(InsuranceStatus value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
